...
.. code:: python
  ...
  >>> ssh.setLogRotateHandler(True) # set bzipped log files (sshParamiko.debug.log.bz2 and sshParamiko.error.log.bz2) to be rotated 
...
.. code:: python
  ...
  Log: Transfering local file localFile.py to remote file /root/remoteFile.py in server myServer | Log level:DEBUG | Date:01/11/2016 12:07:44
  TrueSize: 542 bytes(0.0 MB) || File transfered. [###################################] 100.0%   
  >>> ssh.closeConnection()
